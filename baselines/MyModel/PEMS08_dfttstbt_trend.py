...
from .arch.DecomposeFormer_tts import DecomposeFormer_TTS
from .arch.DecomposeFormer_tts_bt import DecomposeFormer_TTS_BT, DecomposeFormer_TTS_TBT
...
MODEL_ARCH = DecomposeFormer_TTS_TBT
